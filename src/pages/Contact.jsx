          ...
          <div className="text-center lg:w-2/3 w-full" bis_skin_checked={1}>
            ...
            <div className="flex justify-center" bis_skin_checked={1}>
              <button className="inline-flex text-white border-0 py-2 px-6 focus:outline-none rounded text-lg">
                <img className='w-10' src="https://firebasestorage.googleapis.com/v0/b/image-to-url-converter-9483c.appspot.com/o/haseeburrehmanjs%40gmail.com%20%2B%201727505771351?alt=media&token=4cdcec99-d124-4441-b555-cf9b9cb9fde3" alt="" />
              </button>
